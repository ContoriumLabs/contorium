...
export interface GuardDetection {
    type: 'protected_path' | 'forbidden_action' | 'forbidden_pattern' | 'hardcoded_value' | 'truth_registry' | 'hardcode_snippet' | 'change_analysis';
    detail: string;
    severity: RiskSeverity;
}
...
export declare const V3_CORE_FREEZE_VERSION: "0.9.5";
