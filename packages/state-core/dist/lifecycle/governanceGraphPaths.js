...
exports.assumptionGraphPath = assumptionGraphPath;
exports.decisionDependencyGraphPath = decisionDependencyGraphPath;
const path = __importStar(require("node:path"));
const GOVERNANCE_DIR = '.contora/governance';
function assumptionGraphPath(workspaceRoot) {
    return path.join(path.resolve(workspaceRoot), GOVERNANCE_DIR, 'assumption_graph.json');
}
function decisionDependencyGraphPath(workspaceRoot) {
