...
export const PROJECT_INTELLIGENCE_SCHEMA = 'project_intelligence.v1' as const;
export const DECISION_PROVENANCE_SCHEMA = 'decision_provenance.v1' as const;
export const WHY_LAYER_SCHEMA = 'why.v1' as const;
export const INTENT_VNEXT_SCHEMA = 'intent.v1' as const;
export const PROJECT_EVOLUTION_SCHEMA = 'project_evolution.v1' as const;
export const IMPACT_GRAPH_SCHEMA = 'impact_graph.v1' as const;
export const CONFIDENCE_INDEX_SCHEMA = 'confidence_index.v1' as const;
/** @deprecated use CONFIDENCE_INDEX_SCHEMA */
export const STABILITY_INDEX_SCHEMA = 'confidence_index.v1' as const;
export const PROVENANCE_CHAIN_SCHEMA = 'provenance_chain.v1' as const;
export const EVOLUTION_GRAPH_SCHEMA = 'evolution_graph.v1' as const;
export const PROJECT_INTELLIGENCE_REPOSITORY_SCHEMA = 'project_intelligence_repository.v1' as const;
export const PROJECT_INTELLIGENCE_HEALTH_SCHEMA = 'project_intelligence_health.v1' as const;
export const PROJECT_INTELLIGENCE_VALIDATION_SCHEMA = 'project_intelligence_validation.v1' as const;
/** @deprecated use PROJECT_INTELLIGENCE_REPOSITORY_SCHEMA */
export const COGNITIVE_ENGINE_SCHEMA = 'project_intelligence_repository.v1' as const;
...
export interface ProjectIdentity {
  ...
  tool_sources?: Array<{ tool: string; last_seen: string }>;
...
// --- Intelligence dimensions (TIMELINE / IMPACT / CONFIDENCE) ---
