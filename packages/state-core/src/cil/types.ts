...
export const COGNITIVE_EVENT_SCHEMA = 'cognitive_event.v1' as const;
export const ADR_RECORD_SCHEMA = 'adr.v2' as const;
export const CIL_INDEX_SCHEMA = 'cil_index.v1' as const;
export const DECISION_GRAPH_SCHEMA = 'decision_graph.v1' as const;
export const PROJECT_SNAPSHOT_SCHEMA = 'project_snapshot.v2' as const;
export const KNOWLEDGE_ENTITY_SCHEMA = 'knowledge_entity.v1' as const;
export const COGNITIVE_HEALTH_SCHEMA = 'cognitive_health.v1' as const;
